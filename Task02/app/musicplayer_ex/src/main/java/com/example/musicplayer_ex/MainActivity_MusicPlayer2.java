...
public class MainActivity_MusicPlayer2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(MainActivity_MusicPlayer2.this, R.raw.fall_in_minsu); //음악파일
