...
public class MainActivity_MusicPlayer3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(MainActivity_MusicPlayer3.this, R.raw.heartsignal2_bgm); //음악파일
...
//        AudioManager mAudioManager = (AudioManager) getSystemService(AUDIO_SERVICE); //오디오매니저 선언
//        if(isPaused) {
//            mAudioManager.setStreamVolume(AudioManager.STREAM_RING,
//                    (int)(mAudioManager.getStreamVolume(AudioManager.STREAM_RING)*5),
...
//        AudioManager mAudioManager = (AudioManager) getSystemService(AUDIO_SERVICE); //오디오매니저 선언
//        mAudioManager.setStreamVolume(AudioManager.STREAM_RING,
//                (int)(mAudioManager.getStreamVolume(AudioManager.STREAM_RING)*0.20),
//                AudioManager.FLAG_PLAY_SOUND);
